...
from .adapter import ContextInteraction
...
class CLIP(Backbone):
    def __init__(self, cfg, input_shape):
        ...
        self.interaction = ContextInteraction(q_dim=192,
                                                           k_dim=768,
                                                           embed_dim=768,
                                                           num_heads=8,
                                                           hidden_dim=768,
    ...
    def extract_features(self, x,text_classifier=None ,num_templates=None):
        return {
    ...
    def extract_features_convnext(self, x, text_classifier=None, num_templates=None):
        out = {}
        adapter_out = []
        ...
        for i in range(4):
            if i == 0:
                ...
                st = self.interaction(x, text_classifier)
                x = st
